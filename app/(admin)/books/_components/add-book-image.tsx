...
import {updateBookImage} from "@/actions/bookActions";
...
const AddBookImage = ({book}: AddBookImageProps) => {
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      setFiles([]);
      toast.success("Book image added!");
    } catch (error: any) {
  ...
  return (
    <div className="my-20 flex w-full items-center justify-center">
      <div className="min-w-[80%] space-y-4 rounded-lg p-5 shadow-lg shadow-black dark:shadow-white">
        ...
        >
          <h1 className="mb-5 text-2xl font-bold">Add Book Image</h1>
          <div
